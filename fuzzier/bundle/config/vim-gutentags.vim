...
" NOTE: In `LeaderF.vim`, `g:Lf_CacheDirectory` is set to `g:data_path`.
"       Thus, `gutentags` shall generate tags in the following subdirectory
"       for `LeaderF`.
let g:gutentags_cache_dir = g:data_path .. '/LeaderF/gtags'
"
...
"
if has('win32')
    let g:gutentags_ctags_executable = 'uctags.exe'
endif
"
let g:gutentags_ctags_extra_args = [
    \ '--extra=+q',
