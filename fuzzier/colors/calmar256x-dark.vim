...
" ==============================================================================
" This color scheme is designed for a 256 color capable terminal like
" xterm-256color, ... or gvim as well.
" It only works in such a terminal and when you have the following settings in
" the vimrc:
" set t_Co=256
"
...
let g:colors_name = "calmar256x-dark"
...
"
" If 'gui-style' is empty, the 'term-style' value is used for the 'gui-style'.
" (Note: not everything is supported by a terminal nor the gui.)
"
" Besides, empty values defaults to 'NONE".
"
" Refer to:  :help highlight-groups
...
"============================================================
" Format:
"   \ [ "color-group",  "term-style", "fg-color", "bg-color", "gui-style", "under-curl-color" ],
let s:colors256 = [
    \ ["Normal",        "",           "41",       "232",      "",          ""   ],
    \ ["Cursor",        "",           "255",      "33",       "",          ""   ],
    \ ["CursorLine",    "",           "",         "233",      "",          ""   ],
    ...
    \ ["Search",        "",           "",         "52",       "",          ""   ],
    \ ["ErrorMsg",      "bold",       "202",      "235",      "",          ""   ],
    \ ["WarningMsg",    "bold",       "190",      "235",      "",          ""   ],
    \ ["ModeMsg",       "bold",       "226",      "18",       "",          ""   ],
    \ ["MoreMsg",       "bold",       "16",       "154",      "",          ""   ],
    \ ["Question",      "bold",       "70",       "",         "",          ""   ],
    \ ["StatusLine",    "",           "190",      "22",       "",          ""   ],
...
let s:colorvim7 = [
    ...
    \ ["TabLineFill",   "",           "247",      "16",       "",          ""   ],
    \ ["CocPumSearch",  "",           "228",      "236",      "",          ""   ],
    \ ["CocFloating",   "",           "250",      "236",      "",          ""   ],
    \ ["CocMenuSel",    "bold",       "226",      "236",      "bold",      ""   ]]
